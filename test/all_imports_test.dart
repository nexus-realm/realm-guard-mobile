...
import 'package:realmguard/core/security/secure_clipboard.dart' as i23;
import 'package:realmguard/core/security/unlock_service.dart' as i24;
import 'package:realmguard/core/security/vault_key_crypto.dart' as i25;
import 'package:realmguard/core/security/vault_migrator.dart' as i26;
import 'package:realmguard/core/security/vault_service.dart' as i27;
import 'package:realmguard/core/security/wrapped_vault_key_store.dart' as i28;
import 'package:realmguard/core/sync/crdt_device_id_store.dart' as i29;
import 'package:realmguard/core/sync/crdt_ffi.dart' as i30;
import 'package:realmguard/core/sync/drift_projector.dart' as i31;
import 'package:realmguard/core/sync/field_value.dart' as i32;
import 'package:realmguard/core/sync/mutex.dart' as i33;
import 'package:realmguard/core/sync/pending_delta_store.dart' as i34;
import 'package:realmguard/core/sync/vault_crdt.dart' as i35;
import 'package:realmguard/core/sync/vault_doc_store.dart' as i36;
import 'package:realmguard/core/sync/vault_fields.dart' as i37;
import 'package:realmguard/core/sync/vault_projection.dart' as i38;
import 'package:realmguard/core/sync/vault_row_map.dart' as i39;
import 'package:realmguard/core/sync/vault_seed.dart' as i40;
import 'package:realmguard/core/theme/app_colors.dart' as i41;
import 'package:realmguard/core/theme/app_decorations.dart' as i42;
import 'package:realmguard/core/theme/app_spacing.dart' as i43;
import 'package:realmguard/core/theme/app_theme.dart' as i44;
import 'package:realmguard/features/auth/data/account_credential_rules.dart'
    as i45;
import 'package:realmguard/features/auth/data/account_id.dart' as i46;
import 'package:realmguard/features/auth/data/auth_exception.dart' as i47;
import 'package:realmguard/features/auth/data/server_config.dart' as i48;
import 'package:realmguard/features/auth/data/stored_vault_key.dart' as i49;
import 'package:realmguard/features/auth/data/username_rules.dart' as i50;
import 'package:realmguard/features/auth/service/auth_service.dart' as i51;
import 'package:realmguard/features/auth/service/opaque_client.dart' as i52;
import 'package:realmguard/features/auth/service/session_store.dart' as i53;
import 'package:realmguard/features/auth/service/vault_key_cipher.dart' as i54;
...
import 'package:realmguard/features/auth/viewmodels/vault_recovery_view_model.dart'
    as i56;
import 'package:realmguard/features/auth/views/sync_page.dart' as i57;
import 'package:realmguard/features/auth/views/vault_recovery_page.dart' as i58;
import 'package:realmguard/features/autofill/data/autofill_matcher.dart' as i59;
...
import 'package:realmguard/features/autofill/viewmodels/autofill_settings_view_model.dart'
    as i63;
import 'package:realmguard/features/autofill/views/autofill_app.dart' as i64;
...
import 'package:realmguard/features/debug/views/security_debug_page.dart'
    as i69;
import 'package:realmguard/features/debug/views/vault_debug_page.dart' as i70;
import 'package:realmguard/features/home/data/base32.dart' as i71;
import 'package:realmguard/features/home/data/credential_draft.dart' as i72;
import 'package:realmguard/features/home/data/custom_field.dart' as i73;
import 'package:realmguard/features/home/data/domain_identity.dart' as i74;
import 'package:realmguard/features/home/data/otpauth_parser.dart' as i75;
import 'package:realmguard/features/home/data/password_strength.dart' as i76;
import 'package:realmguard/features/home/data/profile_colors.dart' as i77;
import 'package:realmguard/features/home/data/profile_deletion_strategy.dart'
    as i78;
import 'package:realmguard/features/home/data/profile_draft.dart' as i79;
import 'package:realmguard/features/home/data/totp_draft.dart' as i80;
import 'package:realmguard/features/home/data/totp_generator.dart' as i81;
...
import 'package:realmguard/features/home/viewmodels/totp_detail_view_model.dart'
    as i87;
import 'package:realmguard/features/home/views/add_credential_page.dart' as i88;
import 'package:realmguard/features/home/views/add_profile_page.dart' as i89;
import 'package:realmguard/features/home/views/add_totp_page.dart' as i90;
import 'package:realmguard/features/home/views/credential_detail_page.dart'
    as i91;
import 'package:realmguard/features/home/views/home_tab.dart' as i92;
import 'package:realmguard/features/home/views/profile_detail_page.dart' as i93;
import 'package:realmguard/features/home/views/profiles_page.dart' as i94;
import 'package:realmguard/features/home/views/scan_totp_page.dart' as i95;
import 'package:realmguard/features/home/views/totp_detail_page.dart' as i96;
...
import 'package:realmguard/features/home/views/widgets/profile_picker.dart'
    as i106;
import 'package:realmguard/features/home/views/widgets/totp_form.dart' as i107;
...
import 'package:realmguard/features/pairing/service/devices_service.dart'
    as i121;
import 'package:realmguard/features/pairing/service/pairing_ffi.dart' as i122;
...
import 'package:realmguard/features/pairing/viewmodels/pairing_source_view_model.dart'
    as i127;
import 'package:realmguard/features/pairing/views/add_device_page.dart' as i128;
import 'package:realmguard/features/pairing/views/devices_page.dart' as i129;
import 'package:realmguard/features/pairing/views/paired_setup_page.dart'
    as i130;
import 'package:realmguard/features/pairing/views/pairing_qr_view.dart' as i131;
...
import 'package:realmguard/features/pairing/views/receive_device_page.dart'
    as i133;
import 'package:realmguard/features/settings/data/legal_documents.dart' as i134;
...
import 'package:realmguard/features/settings/viewmodels/settings_view_model.dart'
    as i138;
import 'package:realmguard/features/settings/views/about_page.dart' as i139;
import 'package:realmguard/features/settings/views/change_password_page.dart'
    as i140;
import 'package:realmguard/features/settings/views/legal_page.dart' as i141;
import 'package:realmguard/features/settings/views/settings_page.dart' as i142;
...
import 'package:realmguard/features/settings/views/widgets/settings_section.dart'
    as i144;
import 'package:realmguard/features/sync/data/sync_exception.dart' as i145;
import 'package:realmguard/features/sync/data/sync_models.dart' as i146;
import 'package:realmguard/features/sync/data/sync_outcome.dart' as i147;
import 'package:realmguard/features/sync/service/sync_api.dart' as i148;
import 'package:realmguard/features/sync/service/sync_controller.dart' as i149;
import 'package:realmguard/features/sync/service/sync_engine.dart' as i150;
import 'package:realmguard/features/sync/service/sync_session_controller.dart'
    as i151;
import 'package:realmguard/features/sync/service/sync_socket.dart' as i152;
import 'package:realmguard/features/unlock/viewmodels/unlock_view_model.dart'
    as i153;
import 'package:realmguard/features/unlock/views/unlock_page.dart' as i154;
import 'package:realmguard/main.dart' as i155;
import 'package:realmguard/shared/notifiers/fab_notifier.dart' as i156;
import 'package:realmguard/shared/notifiers/fab_notifier_scope.dart' as i157;
import 'package:realmguard/shared/notifiers/search_notifier.dart' as i158;
import 'package:realmguard/shared/notifiers/search_notifier_scope.dart' as i159;
import 'package:realmguard/shared/viewmodels/home_view_model.dart' as i160;
import 'package:realmguard/shared/views/home/home_shell.dart' as i161;
import 'package:realmguard/shared/widgets/app_snackbar.dart' as i162;
import 'package:realmguard/shared/widgets/choice_card.dart' as i163;
import 'package:realmguard/shared/widgets/destructive_button.dart' as i164;
import 'package:realmguard/shared/widgets/gradient_elevated_button.dart'
    as i165;
import 'package:realmguard/shared/widgets/neon_box_decoration.dart' as i166;
import 'package:realmguard/shared/widgets/password_form.dart' as i167;
import 'package:realmguard/shared/widgets/secondary_button.dart' as i168;
import 'package:realmguard/shared/widgets/view_title.dart' as i169;
...
const _generated = <String>[
  ...
  'lib/core/security/secure_clipboard.dart',
